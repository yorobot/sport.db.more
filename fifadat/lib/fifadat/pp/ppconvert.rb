...
#  handle score
 ## m = (full) match hash incl.  IdMatch, etc.
  ...
  score = if resultType == 2   ## aet, win on pens
             { et: [live['HomeTeam']['Score'],live['AwayTeamScore']['Score']],
...
##
##  add players
        rec[:players1]   = build_players( live['HomeTeam']['Players'] )
        rec[:players2]   = build_players( live['AwayTeam']['Players'] )


## add bookings (yellow/red/red-yellow cards)


## add substitutions (in/out)
